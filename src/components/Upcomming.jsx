			...
			>
				...
				<Box width="100%" align="left">
					<Box position="relative">
						<Image position="relative" w="100%" src={Upcommingone} alt="brand" />
						<Box
							position="absolute"
							d="flex"
							alignItems="center"
				...
				<Box width="100%" align="left">
					<Box position="relative">
						<Image position="relative" w="100%" src={Upcommingtwo} alt="brand" />
						<Box
							position="absolute"
							d="flex"
							alignItems="center"
				...
				<Box width="100%" align="left">
					<Box position="relative">
						<Image position="relative" w="100%" src={Upcommingthree} alt="brand" />
						<Box
							position="absolute"
							d="flex"
							alignItems="center"
				...
				<Box width="100%" align="left">
					<Box position="relative">
						<Image position="relative" w="100%" src={Upcommingfour} alt="brand" />
						<Box
							position="absolute"
							d="flex"
							alignItems="center"
